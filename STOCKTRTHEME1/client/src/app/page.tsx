    ...
    <NavBarNoAUTH2 />
     ...
     <div className="pt-8">
          <div className="flex justify-center text-center mb-6">
            <h1 className="text-[2rem] font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Welcome to StockTracker Pro</h1>
          </div>
          ...
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-600/50 p-8 mb-8 mx-4 hover:shadow-3xl transition-all duration-300">
            <div className="flex justify-center text-center mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-6 text-center">
              ...
              <div className="bg-gray-700/80 p-6 rounded-xl shadow-lg border border-indigo-400/50 hover:shadow-xl hover:scale-105 transition-all duration-300">
                <div className="font-bold text-2xl text-indigo-400 mb-2">GOOGL</div>
                <div className="text-green-400 font-semibold text-lg">+1.8%</div>
                <div className="text-gray-300 text-sm mt-1">Alphabet Inc.</div>
              </div>

              <div className="bg-gray-700/80 p-6 rounded-xl shadow-lg border border-purple-400/50 hover:shadow-xl hover:scale-105 transition-all duration-300">
              ...
              <div className="bg-gray-700/80 p-6 rounded-xl shadow-lg border border-cyan-400/50 hover:shadow-xl hover:scale-105 transition-all duration-300">
                <div className="font-bold text-2xl text-cyan-400 mb-2">AMZN</div>
